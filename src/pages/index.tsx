        ...
        <div className="main-content">
            ...
            <div className="container">
                <div className="intro">
                    ...
                    <p>
                        I'm that <b>Frontend Engineer</b> who comes up with
                        creative CSS ideas at 2.00 am. Who always tries to
                        reduce the no. of lines in any given file. <br />
                        <br /> A <b>Javascript developer</b> who thinks that -{" "}
                        <em>
                            "There is always a simpler way to solve a problem."
                        </em>
                    </p>
                    <p>❤ ❤ ❤</p>
                </div>
                ...
                <div className="blogs">
                    ...
                    <div className="card read-more">
                        ...
                        <div className="card__details">
                            <div className="card__title">
                                <h2>
                                    I write about Javascript, CSS, and all
                                    things web.
                                </h2>
                            </div>
                            <div className="card__description">
                                If you love to read tech blogs? I got you
                                covered. I post new content <b>every week.</b> I
                                write about web,{" "}
                                <b>
                                    ReactJS, Typescript, NodeJS, CSS, Developer
                                    productivity tips,{" "}
                                </b>{" "}
                                etc.
                            </div>
                ...
                <div className="cards">
                    ...
                    >
                        <div className="card featured card__details">
                            ...
                            <div className="card__description">
                                A tool that helps you to create motivational
                                quotes with backgrounds.
                            </div>
                    ...
                    >
                        <div className="card card__details">
                            ...
                            <div className="card__description">
                                An API that can give you the pastense of any
                                verb that is provided.
                            </div>
                            <div className="text-caption technologies">
                                ExpressJS, KnockoutJS, jQuery, NodeJs, CSS3,
                                HTML5
                            </div>
                        </div>
                    </Link>
                    ...
                    >
                        <div className="card card__details">
                            ...
                            <div className="card__description">
                                This is a network chart built using Highchart
                                APIs - helps you visualise connections.
                            </div>
                            <div className="text-caption technologies">
                                Vannila Javascript, Highcharts Custom module,
                                SVG, HTML, CSS
                            </div>
                        </div>
                    </a>
                ...
                <div className="timeline-holder">
                    <Block className="timeline" spacing={[40]}>
                        ...
                        <TextBlock
                            ...
                            className="subtext"
                        >
                            I was hired as intern during campus placements,
                            where I worked with C, C++ after which I became a
                            full-time SDE
                        </TextBlock>
                    </Block>
                    <Block className="timeline" spacing={[40]}>
                        ...
                        <TextBlock
                            ...
                            className="subtext"
                        >
                            Not sure if it was my luck or destiny, I was moved
                            to the web development team that was incharge of
                            building SPAs and dynamic web apps.
                        </TextBlock>
                    </Block>
                    <Block className="timeline" spacing={[40]}>
                        <Block spacing={[5]} className="year">
                        ...
                        <TextBlock
                            ...
                            className="subtext"
                        >
                            As a Frontend Developer, I was given total freedom
                            to implement my learnings. My job was to build
                    ...
                    <Block className="timeline" spacing={[40]}>
                        ...
                        <TextBlock
                            ...
                            className="subtext"
                        >
                            TBH, This year and the next year went by within a
                            wink. All I did was sanitize my hands 3 times a day.
                        </TextBlock>
                    </Block>
                    <Block className="timeline" spacing={[40]}>
                        <Block spacing={[5]} className="year">
                        ...
                        >
                            ...
                            , where I worked with awesome tech stack - Electron,
                            React, Vue, Redux, SCSS, etc
                        </TextBlock>
                    </Block>
                    <Block className="timeline" spacing={[40]}>
                        <Block spacing={[5]} className="year">
                        ...
                        <TextBlock
                            ...
                            className="subtext"
                        >
                            I can say, that I've mastered React at this point*.
                            It's all about understanding how values are passed,
                            event loops, and other core concepts. This year
                            helped me learn a lot of things and manage people.
                        </TextBlock>
                    </Block>
                    <Block className="timeline" spacing={[40]}>
                        <Block spacing={[5]} className="year">
                        ...
                        <TextBlock
                            ...
                            className="subtext"
                        >
                            In 2023, as a Senior UI engineer at Plivo, I am
                            focused on exciting new feature development and
                            optimizing performance for large user data handling.
                            I am eager to expand my skillset and explore the
                            applications of machine learning and artificial
                            intelligence to enhance Plivo's products and
                            services.
                        </TextBlock>
                    </Block>
                </div>
            ...
            <div className="section">
                ...
                <TextBlock spacing={[40, 25]}>
                    I use WakaTime to track my coding activity. It's a great
                    tool to track your coding activity and helps you improve
                    your productivity. It's facinating how IDE's have evolved
                    over the years.
                    <p></p>I started with Notepad++, then moved to Visual
                    Studio, and now I am using VSCode and NeoVim. Tracking time
                    helps me to understand how much time I spend on each project
                    and helps me to improve my productivity.
                </TextBlock>
            ...
            <div className="section">
                ...
                <div>
                    <TextBlock spacing={[0, 25]}>
                        I’m the kind of person who likes to connect with new
                        people.
                        <br />
                    ...
                    <Block display="flex" alignItems="center" gap={16}>
                        ...
                        <Block>
                            ...
                            <Block display="flex" gap={12} spacing={[12]}>
                                ...
                                <Text type="caption">
                                    <a href="https://twitter.com/samuellawrentz">
                                        Twitter
                                    </a>
                                </Text>
                                <Text type="caption">
                                    <a href="https://codepen.io/samuellawrentz">
                                        Codepen
                                    </a>
                                </Text>
                            </Block>
