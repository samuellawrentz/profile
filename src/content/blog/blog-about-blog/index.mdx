...
9. Now again, I've got the flame, this time much stronger. I created this blog from scratch, taking reference and inspiration from various other blogs. I created my [portfolio website](https://samuellawrentz.com/blog/vim-experience-nvim-dev-experience/).
	- The **PageSpeed** is almost 100, and you can [monitor website pagespeed with googlesheets](https://samuellawrentz.com/blog/monitor-website-pagespeed-with-googlesheets/)
	- The page size is maximum **22kb**
	- The design is sleek
	- I have full control over what gets shown
	- It's **React** and **GatsbyJS**. You can learn some [coding standards with husky, typescript and lint-staged](https://samuellawrentz.com/blog/coding-standards-husky-typescript-lint-staged) to make your React and GatsbyJS code better.
	- I feel great
10. Now I want to make this blog a place where developers can learn new things and this also serves as a portfolio for my profile. You can read about [incremental faster builds with Gatsby and Github Actions](https://samuellawrentz.com/blog/gatsby-incremental-faster-builds-github-actions/) here.
11. Wish me luck over the coming years - wanna see some traffic here.

If you have any suggestions or improvements or tips and tricks, please DM me or <a target="_blank" href="https://twitter.com/intent/tweet?screen_name=samuellawrentz&ref_src=twsrc%5Etfw" class="twitter-mention-button" data-show-count="false">Tweet to @samuellawrentz</a>