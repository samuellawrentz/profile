...
The idea is simple, we just get a random index between 0 and array's length and pick a value using that index. But the catch here is that Math.random() gives us a decimal with greater precision so we floor the random number to an integer. [Understanding arrow functions in event handlers](https://samuellawrentz.com/hacks/react/understanding-arrow-functions-in-event-handlers) can also be handy in this case.
...
<iframe
  ...
  style="width: 100%;"
  scrolling="no"
  title="Random Array Value"
  src="https://codepen.io/yLevMwd/embed/yLevMwd?default-tab=result"
  frameborder="no"
  loading="lazy"
  allowtransparency="true"
  allowfullscreen="true"
>
  See the Pen on <a href="https://codepen.io/pen/yLevMwd">CodePen</a>.
</iframe>
